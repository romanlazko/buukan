...
<a {{ $attributes->merge(['class' => 'block w-full border-l-4 lg:border-l-0 lg:border-b-2 px-2 lg:px-0 py-2 text-left text-base font-base transition duration-150 ease-in-out' . $activeClasses]) }}>
