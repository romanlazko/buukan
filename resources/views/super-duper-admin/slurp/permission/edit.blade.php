<x-app-layout>
    ...
    <div class="py-4 sm:p-4">
        <div class="w-full space-y-6 m-auto max-w-2xl">
            <x-white-block>
                <x-form.post method="patch" action="{{ route('super-duper-admin.permission.update', $permission) }}">
                    <div>
                    ...
                    <div>
                        ...
                        <x-form.input id="guard_name" name="guard_name" type="text" class="mt-1 block w-full" :value="old('guard_name', $permission->guard_name)" required autocomplete="guard_name" />
