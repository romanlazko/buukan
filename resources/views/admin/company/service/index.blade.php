<x-app-layout>
    ...
    <div class="py-4 sm:p-4 space-y-6">
        ...
        <div class="w-full items-center justify-center">
            <a href="{{ route('admin.company.service.create', $company) }}" class="block m-auto w-min whitespace-nowrap text-xl text-gray-500 hover:bg-indigo-700 hover:text-white p-3 rounded-lg">
