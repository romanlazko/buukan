...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super-duper-admin.slurp.role.index', compact([
            'roles'
        ]));
    }
    ...
    public function create()
    {
        ...
        return view('super-duper-admin.slurp.role.create', compact(
            'permissions'
        ));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('super-duper-admin.role.index')->with([
            'ok' => true,
    ...
    {
        $permissions = Permission::orderBy('id')->get();
        return view('super-duper-admin.slurp.role.edit', compact(
            'role',
            'permissions'
        ));
    }
